...
<img src="docs/assets/images/build-with-ai-mark.svg" width="110" alt="Build With AI" />
...
<img src="docs/assets/images/builder-loop.svg" width="480" alt="The Builder Loop: Vision → Context → Build → Verify → Ship" />
