...
<div markdown>
<span class="course-badge">Agentic AI course</span>
...
[Join the cohort](course/join.md){ .md-button }

</div>

![The Builder Loop: Vision, Context, Build, Verify, Ship](assets/images/builder-loop.svg)
...
[Start at Chapter 1](lessons/01_the_shift/README.md){ .md-button }
</div>
...
[Jump to Chapter 4](lessons/04_the_agentic_loop/README.md){ .md-button }
</div>
...
[Jump to Chapter 2](lessons/02_how_ai_actually_works/README.md){ .md-button }
</div>
...
!!! tip "New to all of this?"
    Start with the [Glossary](course/glossary.md) so the vocabulary never blocks you, then do [Setup](course/setup.md) before your first build session.

!!! warning "Agents act — that's the point, and the risk"
