...
None for the no-code lane. The engineer lane assumes you can read code and use Git, but every tool is introduced before it's used. If you hit an unfamiliar term, check the [Glossary](glossary.md) first — it exists so vocabulary never blocks you.
