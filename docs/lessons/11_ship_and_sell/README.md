...
Somewhere back in Chapter 1 you wrote three builds in your journal and a job-posting line that intimidated you. Go read that entry right now — before this chapter. Seriously, go.

Back? Good. That gap you just felt between then-you and now-you: this chapter is about making the world pay attention to it. Let's finish.

<!-- lesson-index:start -->

## Lessons in this chapter

- [11.1 Launch: Beyond GitHub Pages](11.1_launch_beyond_github_pages.md)
- [11.2 Running It: Production Habits](11.2_running_it_production_habits.md)
- [11.3 The Economics: Costs, Models, Budgets](11.3_the_economics_costs_models_budgets.md)
- [11.4 Getting Paid: Freelance, Products, Career](11.4_getting_paid_freelance_products_career.md)
