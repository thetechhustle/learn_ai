...
1. **Recon session** (read-only, plan mode): `Explore this codebase. What does it do, how is it organized, what stack, what state is it in? Write your findings to docs/orientation.md.`
2. **Read the output yourself.** You're onboarding too — and you're checking the agent's map against reality before you both start trusting it.
...
1. Run the recon session; read `docs/orientation.md` critically. Spot-check two claims against the actual code (calibration, always).
