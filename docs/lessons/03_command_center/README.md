...
!!! example "Watch with this chapter"
    - [Git and GitHub for Beginners — Crash Course](https://www.youtube.com/watch?v=RGOj5yH7evk) — freeCodeCamp (1 hr). The first 30 minutes covers everything Lesson 3.3 uses.
    - [Mastering Claude Code in 30 Minutes](https://www.youtube.com/watch?v=B_KAEqiC-0Q) — Boris Cherny. Watch after Lesson 3.4 — it'll land completely differently now that you've driven.
...
- [3.1 Meet the Terminal](3.1_meet_the_terminal.md)
- [3.2 Files, Folders, and Paths](3.2_files_folders_and_paths.md)
- [3.3 Git: Your Safety Net](3.3_git_your_safety_net.md)
- [3.4 Your First Claude Code Session](3.4_your_first_claude_code_session.md)
