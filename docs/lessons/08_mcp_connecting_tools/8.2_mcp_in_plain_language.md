...
=== "⚙️ Engineer lane"
    ...
    Under the hood for the curious: JSON-RPC over stdio for local servers or HTTP for remote ones; servers declare capabilities at handshake; tool schemas are JSON Schema. Use the current [Model Context Protocol documentation](https://modelcontextprotocol.io/docs/getting-started/intro) and official SDK guidance when estimating or implementing a server. Scope and security review determine the work; the course does not assign a universal build time.
