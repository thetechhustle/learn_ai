...
5. **Reasons ride along.** "One idea per issue — *multiple competing ideas can split attention*" survives novel situations; the bare rule invites clever violations. (5.4's lesson, still true.)
